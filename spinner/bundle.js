...
function updateBackground(t) {
    ...
    if (!backgroundAnimating && backgroundInit) {
        ...
        backgroundAnimating = !0, $("body").animate({backgroundColor: e}, n, function () {
...
function updatePos(t, e) {
    var n = $(e.el);
    $(".spinner").css({top: n.position().top - initialOffset, left: n.position().left - initialOffset})
}
!function (t, e) {
    "use strict";
    ...
    function g(t, e, n, i) {
        var o, r = 1, s = 20, a = i ? function () {
            ...
            return gt.css(t, e, "")
        }, u = a(), l = n && n[3] || (gt.cssNumber[e] ? "" : "px"), c = (gt.cssNumber[e] || "px" !== l && +u) && It.exec(gt.css(t, e));
        if (c && c[3] !== l) {
            l = l || c[3], n = n || [], c = +u || 1;
            do {
    ...
    function m(t) {
        var e, n = t.ownerDocument, i = t.nodeName, o = Wt[i];
    ...
    function b(t, e, n, i, o) {
        for (var r, s, a, u, l, c, p = e.createDocumentFragment(), h = [], f = 0, d = t.length; f < d; f++)if ((r = t[f]) || 0 === r)if ("object" === gt.type(r))gt.merge(h, r.nodeType ? [r] : r); else if (Yt.test(r)) {
        ...
        for (p.textContent = "", f = 0; r = h[f++];)if (i && gt.inArray(r, i) > -1)o && o.push(r); else if (l = gt.contains(r.ownerDocument, r), s = y(p.appendChild(r), "script"), l && x(s), n)for (c = 0; r = s[c++];)zt.test(r.type || "") && n.push(r);
        return p
    }
    ...
    function D(t, e) {
        ...
        if (1 === e.nodeType) {
            if (Lt.hasData(t) && (r = Lt.access(t), s = Lt.set(e, r), l = r.events)) {
                ...
                for (o in l)for (n = 0, i = l[o].length; n < i; n++)gt.event.add(e, o, l[o][n])
            }
    ...
    function M(t, e, i, o) {
        e = rt.apply([], e);
        var r, s, a, u, l, c, p = 0, h = t.length, f = h - 1, d = e[0], g = gt.isFunction(d);
        ...
        if (h && (r = b(e, t[0].ownerDocument, !1, t, o), s = r.firstChild, 1 === r.childNodes.length && (r = s), s || o)) {
            ...
            if (u)for (c = a[a.length - 1].ownerDocument, gt.map(a, k), p = 0; p < u; p++)l = a[p], zt.test(l.type || "") && !Lt.access(l, "globalEval") && gt.contains(c, l) && (l.src ? gt._evalUrl && gt._evalUrl(l.src) : n(l.textContent.replace(te, ""), c))
        }
        return t
    }
    ...
    function P(t) {
        if (t in le)return t;
        for (var e = t[0].toUpperCase() + t.slice(1), n = ue.length; n--;)if ((t = ue[n] + e) in le)return t
    }
    ...
    function F(t, e, n) {
        var i, o = ie(t), r = L(t, e, o), s = "border-box" === gt.css(t, "boxSizing", !1, o);
    ...
    function B(t, e, n) {
        for (var i, o = (Y.tweeners[e] || []).concat(Y.tweeners["*"]), r = 0, s = o.length; r < s; r++)if (i = o[r].call(n, e, t))return i
    }

    function z(t, e, n) {
        var i, o, r, s, a, u, l, c, p = "width" in e || "height" in e, h = this, f = {}, d = t.style, g = t.nodeType && Ot(t), m = Lt.get(t, "fxshow");
        ...
        if ((u = !gt.isEmptyObject(e)) || !gt.isEmptyObject(f)) {
            ...
            for (i in f)u || (m ? "hidden" in m && (g = m.hidden) : m = Lt.access(t, "fxshow", {display: l}), r && (m.hidden = !g), g && v([t], !0), h.done(function () {
    ...
    function X(t, e) {
        var n, i, o, r, s;
        for (n in t)if (i = gt.camelCase(n), o = e[i], r = t[n], Array.isArray(r) && (o = r[1], r = t[n] = r[0]), n !== i && (t[i] = r, delete t[n]), (s = gt.cssHooks[i]) && "expand" in s) {
    ...
    function Y(t, e, n) {
        var i, o, r = 0, s = Y.prefilters.length, a = gt.Deferred().always(function () {
            delete u.elem
        }), u = function () {
            if (o)return !1;
        ...
        for (X(c, l.opts.specialEasing); r < s; r++)if (i = Y.prefilters[r].call(l, t, c, l.opts))return gt.isFunction(i.stop) && (gt._queueHooks(l.elem, l.opts.queue).stop = gt.proxy(i.stop, i)), i;
    ...
    function Q(t, e, n, i) {
        ...
        }); else if (n || "object" !== gt.type(e))i(t, e); else for (o in e)Q(t + "[" + o + "]", e[o], n, i)
    }
    ...
    function G(t) {
        return function (e, n) {
            ...
            if (gt.isFunction(n))for (; i = r[o++];)"+" === i[0] ? (i = i.slice(1) || "*", (t[i] = t[i] || []).unshift(n)) : (t[i] = t[i] || []).push(n)
        }
    }
    ...
    function Z(t, e, n) {
        for (var i, o, r, s, a = t.contents, u = t.dataTypes; "*" === u[0];)u.shift(), void 0 === i && (i = t.mimeType || e.getResponseHeader("Content-Type"));
    ...
    function tt(t, e, n, i) {
        var o, r, s, a, u, l = {}, c = t.dataTypes.slice();
        if (c[1])for (s in t.converters)l[s.toLowerCase()] = t.converters[s];
        for (r = c.shift(); r;)if (t.responseFields[r] && (n[t.responseFields[r]] = e), !u && i && t.dataFilter && (e = t.dataFilter(e, t.dataType)), u = r, r = c.shift())if ("*" === r)r = u; else if ("*" !== u && u !== r) {
            if (!(s = l[u + " " + r] || l["* " + r]))for (o in l)if (a = o.split(" "), a[1] === r && (s = l[u + " " + a[0]] || l["* " + a[0]])) {
            ...
            if (!0 !== s)if (s && t.throws)e = s(e); else try {
                ...
                return {state: "parsererror", error: s ? t : "No conversion from " + u + " to " + r}
            }
        }
        return {state: "success", data: e}
    }

    var et = [], nt = t.document, it = Object.getPrototypeOf, ot = et.slice, rt = et.concat, st = et.push, at = et.indexOf, ut = {}, lt = ut.toString, ct = ut.hasOwnProperty, pt = ct.toString, ht = pt.call(Object), ft = {}, dt = "3.2.1", gt = function (t, e) {
        return new gt.fn.init(t, e)
    }, mt = function (t, e) {
        return e.toUpperCase()
    };
    gt.fn = gt.prototype = {
        jquery: dt, constructor: gt, length: 0, toArray: function () {
            return ot.call(this)
        }, get: function (t) {
        ...
        var t, e, n, i, o, r, s = arguments[0] || {}, a = 1, u = arguments.length, l = !1;
        for ("boolean" == typeof s && (l = s, s = arguments[a] || {}, a++), "object" == typeof s || gt.isFunction(s) || (s = {}), a === u && (s = this, a--); a < u; a++)if (null != (t = arguments[a]))for (e in t)n = s[e], i = t[e], s !== i && (l && i && (gt.isPlainObject(i) || (o = Array.isArray(i))) ? (o ? (o = !1, r = n && Array.isArray(n) ? n : []) : r = n && gt.isPlainObject(n) ? n : {}, s[e] = gt.extend(l, r, i)) : void 0 !== i && (s[e] = i));
        return s
    }, gt.extend({
    ...
    var vt = function (t) {
        function e(t, e, n, i) {
            var o, r, s, a, u, c, h, f = e && e.ownerDocument, d = e ? e.nodeType : 9;
            if (n = n || [], "string" != typeof t || !t || 1 !== d && 9 !== d && 11 !== d)return n;
            if (!i && ((e ? e.ownerDocument || e : O) !== j && M(e), e = e || j, $)) {
                if (11 !== d && (u = gt.exec(t)))if (o = u[1]) {
                    if (9 === d) {
                ...
                if (b.qsa && !z[t + " "] && (!P || !P.test(t))) {
                    if (1 !== d)f = e, h = t; else if ("object" !== e.nodeName.toLowerCase()) {
        ...
        function h(t, e, n) {
            ...
            return e.first ? function (e, n, o) {
                ...
                } else for (; e = e[i];)if (1 === e.nodeType || s)if (p = e[F] || (e[F] = {}), c = p[e.uniqueID] || (p[e.uniqueID] = {}), o && o === e.nodeName.toLowerCase())e = e[i] || e; else {
        ...
        function m(t, e, n, o, r, s) {
            return o && !o[F] && (o = m(o)), r && !r[F] && (r = m(r, s)), i(function (i, s, a, u) {
                var l, c, p, h = [], f = [], m = s.length, v = i || d(e || "*", a.nodeType ? [a] : a, []), y = !t || !i && e ? v : g(v, h, t, a, u), x = n ? r || (i ? t : m || o) ? [] : s : y;
                if (n && n(y, x, a, u), o)for (l = g(x, f), o(l, [], a, u), c = l.length; c--;)(p = l[c]) && (x[f[c]] = !(y[f[c]] = p));
                if (i) {
                    if (r || t) {
                        if (r) {
        ...
        function v(t) {
            for (var e, n, i, o = t.length, r = T.relative[t[0].type], s = r || T.relative[" "], a = r ? 1 : 0, u = h(function (t) {
                ...
                if (n = T.filter[t[a].type].apply(null, t[a].matches), n[F]) {
                    ...
                    return m(a > 1 && f(c), a > 1 && p(t.slice(0, a - 1).concat({value: " " === t[a - 2].type ? "*" : ""})).replace(rt, "$1"), n, a < i && v(t.slice(a, i)), i < o && v(t = t.slice(i)), i < o && p(t))
                }
                c.push(n)
            }
            return f(c)
        ...
        function y(t, n) {
            var o = n.length > 0, r = t.length > 0, s = function (i, s, a, u, l) {
                var c, p, h, f = 0, d = "0", m = i && [], v = [], y = k, x = i || r && T.find.TAG("*", l), b = H += null == y ? 1 : Math.random() || .1, w = x.length;
                for (l && (k = s === j || s || l); d !== w && null != (c = x[d]); d++) {
                    if (r && c) {
                        for (p = 0, s || c.ownerDocument === j || (M(c), a = !$); h = t[p++];)if (h(c, s || j, a)) {
                            u.push(c);
                            break
                        }
                        l && (H = b)
                ...
                if (f += d, o && d !== f) {
                    ...
                    if (i) {
                        if (f > 0)for (; d--;)m[d] || v[d] || (v[d] = U.call(u));
                        v = g(v)
                    }
        ...
        var x, b, T, w, C, S, E, A, k, D, N, M, j, L, $, P, q, R, I, F = "sizzle" + 1 * new Date, O = t.document, H = 0, W = 0, _ = n(), B = n(), z = n(), X = function (t, e) {
            return t === e && (N = !0), 0
        }, Y = {}.hasOwnProperty, V = [], U = V.pop, Q = V.push, G = V.push, J = V.slice, K = function (t, e) {
            for (var n = 0, i = t.length; n < i; n++)if (t[n] === e)return n;
            return -1
        }, Z = "checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped", tt = "[\\x20\\t\\r\\n\\f]", et = "(?:\\\\.|[\\w-]|[^\0-\\xa0])+", nt = "\\[" + tt + "*(" + et + ")(?:" + tt + "*([*^$|!~]?=)" + tt + "*(?:'((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\"|(" + et + "))|)" + tt + "*\\]", it = ":(" + et + ")(?:\\((('((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\")|((?:\\\\.|[^\\\\()[\\]]|" + nt + ")*)|.*)\\)|)", ot = new RegExp(tt + "+", "g"), rt = new RegExp("^" + tt + "+|((?:^|[^\\\\])(?:\\\\.)*)" + tt + "+$", "g"), st = new RegExp("^" + tt + "*," + tt + "*"), at = new RegExp("^" + tt + "*([>+~]|" + tt + ")" + tt + "*"), ut = new RegExp("=" + tt + "*([^\\]'\"]*?)" + tt + "*\\]", "g"), lt = new RegExp(it), ct = new RegExp("^" + et + "$"), pt = {
            ID: new RegExp("^#(" + et + ")"),
            CLASS: new RegExp("^\\.(" + et + ")"),
            TAG: new RegExp("^(" + et + "|[*])"),
            ATTR: new RegExp("^" + nt),
        ...
        }, ht = /^(?:input|select|textarea|button)$/i, ft = /^h\d$/i, dt = /^[^{]+\{\s*\[native \w/, gt = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/, mt = /[+~]/, vt = new RegExp("\\\\([\\da-f]{1,6}" + tt + "?|(" + tt + ")|.)", "ig"), yt = function (t, e, n) {
            var i = "0x" + e - 65536;
        ...
        b = e.support = {}, C = e.isXML = function (t) {
            ...
            return i !== j && 9 === i.nodeType && i.documentElement ? (j = i, L = j.documentElement, $ = !C(j), O !== j && (n = j.defaultView) && n.top !== n && (n.addEventListener ? n.addEventListener("unload", Tt, !1) : n.attachEvent && n.attachEvent("onunload", Tt)), b.attributes = o(function (t) {
                ...
                if (t === e)return N = !0, 0;
                var n, i = 0, o = t.parentNode, r = e.parentNode, a = [t], u = [e];
            ...
            var n = T.attrHandle[e.toLowerCase()], i = n && Y.call(T.attrHandle, e.toLowerCase()) ? n(t, e, !$) : void 0;
            ...
            filter: {
                TAG: function (t) {
                    ...
                    return 1 === i && 0 === o ? function (t) {
                        ...
                        var l, c, p, h, f, d, g = r !== s ? "nextSibling" : "previousSibling", m = e.parentNode, v = a && e.nodeName.toLowerCase(), y = !u && !a, x = !1;
                        if (m) {
                            if (r) {
                                for (; g;) {
                            ...
                            if (d = [s ? m.firstChild : m.lastChild], s && y) {
                                for (h = m, p = h[F] || (h[F] = {}), c = p[h.uniqueID] || (p[h.uniqueID] = {}), l = c[t] || [], f = l[0] === H && l[1], x = f && l[2], h = f && m.childNodes[f]; h = ++f && h && h[g] || (x = f = 0) || d.pop();)if (1 === h.nodeType && ++x && h === e) {
                                    c[t] = [H, f, x];
                                    break
                                }
                            } else if (y && (h = e, p = h[F] || (h[F] = {}), c = p[h.uniqueID] || (p[h.uniqueID] = {}), l = c[t] || [], f = l[0] === H && l[1], x = f), !1 === x)for (; (h = ++f && h && h[g] || (x = f = 0) || d.pop()) && ((a ? h.nodeName.toLowerCase() !== v : 1 !== h.nodeType) || !++x || (y && (p = h[F] || (h[F] = {}), c = p[h.uniqueID] || (p[h.uniqueID] = {}), c[t] = [H, x]), h !== e)););
        ...
        for (x in{radio: !0, checkbox: !0, file: !0, password: !0, image: !0})T.pseudos[x] = function (t) {
            return function (e) {
                return "input" === e.nodeName.toLowerCase() && e.type === t
            }
        }(x);
        for (x in{submit: !0, reset: !0})T.pseudos[x] = function (t) {
            return function (e) {
                var n = e.nodeName.toLowerCase();
        ...
        return c.prototype = T.filters = T.pseudos, T.setFilters = new c, S = e.tokenize = function (t, n) {
            ...
            var o, r, s, a, u, c = "function" == typeof t && t, h = !i && S(t = c.selector || t);
            if (n = n || [], 1 === h.length) {
                ...
                for (o = pt.needsContext.test(t) ? 0 : r.length; o-- && (s = r[o], !T.relative[a = s.type]);)if ((u = T.find[a]) && (i = u(s.matches[0].replace(vt, yt), mt.test(r[0].type) && l(e.parentNode) || e))) {
    ...
    var yt = function (t, e, n) {
        ...
        return n
    }, bt = gt.expr.match.needsContext, Tt = /^<([a-z][^\/\0>:\x20\t\r\n\f]*)[\x20\t\r\n\f]*\/?>(?:<\/\1>|)$/i, wt = /^.[^:#\[\.,]*$/;
    gt.filter = function (t, e, n) {
        ...
        find: function (t) {
            ...
            if ("string" != typeof t)return this.pushStack(gt(t).filter(function () {
                for (e = 0; e < i; e++)if (gt.contains(o[e], this))return !0
            }));
    ...
    (gt.fn.init = function (t, e, n) {
        ...
        if (n = n || Ct, "string" == typeof t) {
            ...
            if (i[1]) {
                if (e = e instanceof gt ? e[0] : e, gt.merge(this, gt.parseHTML(i[1], e && e.nodeType ? e.ownerDocument || e : nt, !0)), Tt.test(i[1]) && gt.isPlainObject(e))for (i in e)gt.isFunction(this[i]) ? this[i](e[i]) : this.attr(i, e[i]);
                return this
            }
    ...
    var Et = /^(?:parents|prev(?:Until|All))/, At = {children: !0, contents: !0, next: !0, prev: !0};
    gt.fn.extend({
        has: function (t) {
            ...
            var n, i = 0, o = this.length, r = [], s = "string" != typeof t && gt(t);
            if (!bt.test(t))for (; i < o; i++)for (n = this[i]; n && n !== e; n = n.parentNode)if (n.nodeType < 11 && (s ? s.index(n) > -1 : 1 === n.nodeType && gt.find.matchesSelector(n, t))) {
                r.push(n);
                break
            }
    ...
    gt.Callbacks = function (t) {
        ...
        var e, n, i, o, r = [], s = [], u = -1, l = function () {
            for (o = o || t.once, i = e = !0; s.length; u = -1)for (n = s.shift(); ++u < r.length;)!1 === r[u].apply(n[0], n[1]) && t.stopOnFalse && (u = r.length, n = !1);
            ...
            add: function () {
                ...
                return gt.each(arguments, function (t, e) {
                    for (var n; (n = gt.inArray(e, r, n)) > -1;)r.splice(n, 1), n <= u && u--
                }), this
            }, has: function (t) {
        ...
        Deferred: function (e) {
            var n = [["notify", "progress", gt.Callbacks("memory"), gt.Callbacks("memory"), 2], ["resolve", "done", gt.Callbacks("once memory"), gt.Callbacks("once memory"), 0, "resolved"], ["reject", "fail", gt.Callbacks("once memory"), gt.Callbacks("once memory"), 1, "rejected"]], i = "pending", o = {
                state: function () {
                    return i
                }, always: function () {
            ...
            var e = arguments.length, n = e, i = Array(n), o = ot.call(arguments), r = gt.Deferred(), s = function (t) {
                return function (n) {
    ...
    h.uid = 1, h.prototype = {
        cache: function (t) {
            ...
            if ("string" == typeof e)o[gt.camelCase(e)] = n; else for (i in e)o[gt.camelCase(i)] = e[i];
            return o
        }, get: function (t, e) {
    ...
    var Lt = new h, $t = new h, Pt = /^(?:\{[\w\W]*\}|\[[\w\W]*\])$/, qt = /[A-Z]/g;
    gt.extend({
        hasData: function (t) {
        ...
        queue: function (t, e, n) {
            ...
            e = e || "fx";
            var n = gt.queue(t, e), i = n.length, o = n.shift(), r = gt._queueHooks(t, e), s = function () {
                gt.dequeue(t, e)
            };
        ...
        queue: function (t, e) {
            ...
            var n, i = 1, o = gt.Deferred(), r = this, s = this.length, a = function () {
                --i || o.resolveWith(r, [r])
            };
    ...
    var Rt = /[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source, It = new RegExp("^(?:([+-])=|)(" + Rt + ")([a-z%]*)$", "i"), Ft = ["Top", "Right", "Bottom", "Left"], Ot = function (t, e) {
    ...
    var _t = /^(?:checkbox|radio)$/i, Bt = /<([a-z][^\/\0>\x20\t\r\n\f]+)/i, zt = /^$|\/(?:java|ecma)script/i, Xt = {
    ...
    var Vt = nt.documentElement, Ut = /^key/, Qt = /^(?:mouse|pointer|contextmenu|drag|drop)|click/, Gt = /^([^.]*)(?:\.(.+)|)/;
    gt.event = {
        global: {}, add: function (t, e, n, i, o) {
            var r, s, a, u, l, c, p, h, f, d, g, m = Lt.get(t);
            if (m)for (n.handler && (r = n, n = r.handler, o = r.selector), o && gt.find.matchesSelector(Vt, o), n.guid || (n.guid = gt.guid++), (u = m.events) || (u = m.events = {}), (s = m.handle) || (s = m.handle = function (e) {
            ...
            if (m && (u = m.events)) {
                for (e = (e || "").match(kt) || [""], l = e.length; l--;)if (a = Gt.exec(e[l]) || [], f = g = a[1], d = (a[2] || "").split(".").sort(), f) {
            ...
            var e, n, i, o, r, s, a = gt.event.fix(t), u = new Array(arguments.length), l = (Lt.get(this, "events") || {})[a.type] || [], c = gt.event.special[a.type] || {};
            for (u[0] = a, e = 1; e < arguments.length; e++)u[e] = arguments[e];
            if (a.delegateTarget = this, !c.preDispatch || !1 !== c.preDispatch.call(this, a)) {
                for (s = gt.event.handlers.call(this, a, l), e = 0; (o = s[e++]) && !a.isPropagationStopped();)for (a.currentTarget = o.elem, n = 0; (r = o.handlers[n++]) && !a.isImmediatePropagationStopped();)a.rnamespace && !a.rnamespace.test(r.namespace) || (a.handleObj = r, a.data = r.data, void 0 !== (i = ((gt.event.special[r.origType] || {}).handle || r.handler).apply(o.elem, u)) && !1 === (a.result = i) && (a.preventDefault(), a.stopPropagation()));
                return c.postDispatch && c.postDispatch.call(this, a), a.result
            }
        }, handlers: function (t, e) {
            var n, i, o, r, s, a = [], u = e.delegateCount, l = t.target;
    ...
    var Jt = /<script|<style|<link/i, Kt = /checked\s*(?:[^=]|=\s*.checked.)/i, Zt = /^true\/(.*)/, te = /^\s*<!(?:\[CDATA\[|--)|(?:\]\]|--)>\s*$/g;
    gt.extend({
        htmlPrefilter: function (t) {
            return t.replace(/<(?!area|br|col|embed|hr|img|input|link|meta|param)(([a-z][^\/\0>\x20\t\r\n\f]*)[^>]*)\/>/gi, "<$1></$2>")
        }, clone: function (t, e, n) {
            var i, o, r, s, a = t.cloneNode(!0), u = gt.contains(t.ownerDocument, t);
            if (!(ft.noCloneChecked || 1 !== t.nodeType && 11 !== t.nodeType || gt.isXMLDoc(t)))for (s = y(a), r = y(t), i = 0, o = r.length; i < o; i++)N(r[i], s[i]);
            ...
            for (var e, n, i, o = gt.event.special, r = 0; void 0 !== (n = t[r]); r++)if (jt(n)) {
                if (e = n[Lt.expando]) {
                    if (e.events)for (i in e.events)o[i] ? gt.event.remove(n, i) : gt.removeEvent(n, i, e.handle);
                    n[Lt.expando] = void 0
                }
    ...
    var ee = /^margin/, ne = new RegExp("^(" + Rt + ")(?!px)[a-z%]+$", "i"), ie = function (e) {
    ...
    var oe = /^(none|table(?!-c[ea]).+)/, re = /^--/, se = {
        position: "absolute",
        visibility: "hidden",
        display: "block"
    }, ae = {letterSpacing: "0", fontWeight: "400"}, ue = ["Webkit", "Moz", "ms"], le = nt.createElement("div").style;
    gt.extend({
        cssHooks: {
            opacity: {
                get: function (t, e) {
        ...
        style: function (t, e, n, i) {
            if (t && 3 !== t.nodeType && 8 !== t.nodeType && t.style) {
                var o, r, s, a = gt.camelCase(e), u = re.test(e), l = t.style;
        ...
        gt.cssHooks[e] = {
            get: function (t, n, i) {
                ...
                var o, r = i && ie(t), s = i && I(t, e, i, "border-box" === gt.css(t, "boxSizing", !1, r), r);
                return s && (o = It.exec(n)) && "px" !== (o[3] || "px") && (t.style[e] = n, n = gt.css(t, e)), R(t, n, s)
            }
        }
    }), gt.cssHooks.marginLeft = $(ft.reliableMarginLeft, function (t, e) {
        if (e)return (parseFloat(L(t, "marginLeft")) || t.getBoundingClientRect().left - Ht(t, {marginLeft: 0}, function () {
    ...
    var ce, pe, he = /^(?:toggle|show|hide)$/, fe = /queueHooks$/;
    gt.Animation = gt.extend(Y, {
        ...
        fadeTo: function (t, e, n, i) {
            ...
            var o = gt.isEmptyObject(t), r = gt.speed(e, n, i), s = function () {
            ...
            return "string" != typeof t && (n = e, e = t, t = void 0), e && !1 !== t && this.queue(t || "fx", []), this.each(function () {
                var e = !0, o = null != t && t + "queueHooks", r = gt.timers, s = Lt.get(this);
                if (o)s[o] && s[o].stop && i(s[o]); else for (o in s)s[o] && s[o].stop && fe.test(o) && i(s[o]);
                for (o = r.length; o--;)r[o].elem !== this || null != t && r[o].queue !== t || (r[o].anim.stop(n), e = !1, r.splice(o, 1));
                !e && n || gt.dequeue(this, t)
            })
        }, finish: function (t) {
            return !1 !== t && (t = t || "fx"), this.each(function () {
                var e, n = Lt.get(this), i = n[t + "queue"], o = n[t + "queueHooks"], r = gt.timers, s = i ? i.length : 0;
        ...
        var t = nt.createElement("input"), e = nt.createElement("select"), n = e.appendChild(nt.createElement("option"));
    ...
    gt.fn.extend({
        ...
        addClass: function (t) {
            ...
            if ("string" == typeof t && t)for (e = t.match(kt) || []; n = this[u++];)if (o = U(n), i = 1 === n.nodeType && " " + V(o) + " ") {
            ...
            return "boolean" == typeof e && "string" === n ? e ? this.addClass(t) : this.removeClass(t) : gt.isFunction(t) ? this.each(function (n) {
                ...
                var e, i, o, r;
                if ("string" === n)for (i = 0, o = gt(this), r = t.match(kt) || []; e = r[i++];)o.hasClass(e) ? o.removeClass(e) : o.addClass(e); else void 0 !== t && "boolean" !== n || (e = U(this), e && Lt.set(this, "__className__", e), this.setAttribute && this.setAttribute("class", e || !1 === t ? "" : Lt.get(this, "__className__") || ""))
            })
        }, hasClass: function (t) {
            var e, n, i = 0;
    ...
    gt.fn.extend({
        ...
        valHooks: {
            option: {
                ...
                get: function (t) {
                    var e, n, i, r = t.options, s = t.selectedIndex, a = "select-one" === t.type, u = a ? null : [], l = a ? s + 1 : r.length;
                    for (i = s < 0 ? l : a ? s : 0; i < l; i++)if (n = r[i], (n.selected || i === s) && !n.disabled && (!n.parentNode.disabled || !o(n.parentNode, "optgroup"))) {
    ...
    gt.extend(gt.event, {
        trigger: function (e, n, i, o) {
            var r, s, a, u, l, c, p, h = [i || nt], f = ct.call(e, "type") ? e.type : e, d = ct.call(e, "namespace") ? e.namespace.split(".") : [];
            if (s = a = i = i || nt, 3 !== i.nodeType && 8 !== i.nodeType && !ye.test(f + gt.event.triggered) && (f.indexOf(".") > -1 && (d = f.split("."), f = d.shift(), d.sort()), l = f.indexOf(":") < 0 && "on" + f, e = e[gt.expando] ? e : new gt.Event(f, "object" == typeof e && e), e.isTrigger = o ? 2 : 3, e.namespace = d.join("."), e.rnamespace = e.namespace ? new RegExp("(^|\\.)" + d.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, e.result = void 0, e.target || (e.target = i), n = null == n ? [e] : gt.makeArray(n, [e]), p = gt.event.special[f] || {}, o || !p.trigger || !1 !== p.trigger.apply(i, n))) {
                ...
                for (r = 0; (s = h[r++]) && !e.isPropagationStopped();)e.type = r > 1 ? u : p.bindType || f, c = (Lt.get(s, "events") || {})[e.type] && Lt.get(s, "handle"), c && c.apply(s, n), (c = l && s[l]) && c.apply && jt(s) && (e.result = c.apply(s, n), !1 === e.result && e.preventDefault());
    ...
    }), ft.focusin = "onfocusin" in t, ft.focusin || gt.each({focus: "focusin", blur: "focusout"}, function (t, e) {
        var n = function (t) {
            gt.event.simulate(e, t.target, gt.event.fix(t))
        };
        gt.event.special[e] = {
            setup: function () {
                var i = this.ownerDocument || this, o = Lt.access(i, e);
                o || i.addEventListener(t, n, !0), Lt.access(i, e, (o || 0) + 1)
            }, teardown: function () {
                var i = this.ownerDocument || this, o = Lt.access(i, e) - 1;
                o ? Lt.access(i, e, o) : (i.removeEventListener(t, n, !0), Lt.remove(i, e))
            }
        }
    });
    var xe = t.location, be = gt.now(), Te = /\?/;
    ...
    var we = /\[\]$/, Ce = /^(?:submit|button|image|reset|file)$/i, Se = /^(?:input|select|textarea|keygen)/i;
    ...
    var Ee = /^(.*?):[ \t]*([^\r\n]*)$/gm, Ae = /^(?:about|app|app-storage|.+-extension|file|res|widget):$/, ke = /^(?:GET|HEAD)$/, De = {}, Ne = {}, Me = "*/".concat("*"), je = nt.createElement("a");
    je.href = xe.href, gt.extend({
        ...
        ajax: function (e, n) {
            ...
            var o, r, s, a, u, l, c, p, h, f, d = gt.ajaxSetup({}, n), g = d.context || d, m = d.context && (g.nodeType || g.jquery) ? gt(g) : gt.event, v = gt.Deferred(), y = gt.Callbacks("once memory"), x = d.statusCode || {}, b = {}, T = {}, w = "canceled", C = {
                readyState: 0,
                ...
                statusCode: function (t) {
                    var e;
                    if (t)if (c)C.always(t[C.status]); else for (e in t)x[e] = [x[e], t[e]];
                    return this
                },
                abort: function (t) {
                    var e = t || w;
    ...
    var Le = {0: 200, 1223: 204}, $e = gt.ajaxSettings.xhr();
    ft.cors = !!$e && "withCredentials" in $e, ft.ajax = $e = !!$e, gt.ajaxTransport(function (e) {
        ...
        if (ft.cors || $e && !e.crossDomain)return {
            send: function (o, r) {
                ...
                n = function (t) {
                    return function () {
                        n && (n = i = a.onload = a.onerror = a.onabort = a.onreadystatechange = null, "abort" === t ? a.abort() : "error" === t ? "number" != typeof a.status ? r(0, "error") : r(a.status, a.statusText) : r(Le[a.status] || a.status, a.statusText, "text" !== (a.responseType || "text") || "string" != typeof a.responseText ? {binary: a.response} : {text: a.responseText}, a.getAllResponseHeaders()))
                    }
    ...
    gt.ajaxSetup({
        ...
        setOffset: function (t, e, n) {
            var i, o, r, s, a, u, l, c = gt.css(t, "position"), p = gt(t), h = {};
    ...
    function i(e) {
        ...
        return e = e.toLowerCase(), f(a, function (t, o) {
            var r, s = o.re.exec(e), a = s && o.parse(s), u = o.space || "rgba";
    ...
    h.style.cssText = "background-color:rgba(1,1,1,.5)", p.rgba = h.style.backgroundColor.indexOf("rgba") > -1, f(l, function (t, e) {
        ...
        parse: function (o, s, a, c) {
            ...
            var p = this, h = t.type(o), d = this._rgba = [];
            ...
            var i = u(t), o = i._space(), r = l[o], s = 0 === this.alpha() ? u("transparent") : this, a = s[r.cache] || r.to(s._rgba), p = a.slice();
            return i = i[r.cache], f(r.props, function (t, o) {
                var r = o.idx, s = a[r], u = i[r], l = c[o.type] || {};
        ...
        var e, n, i = t[0] / 255, o = t[1] / 255, r = t[2] / 255, s = t[3], a = Math.max(i, o, r), u = Math.min(i, o, r), l = a - u, c = a + u, p = .5 * c;
        ...
        if (null == t[0] || null == t[1] || null == t[2])return [null, null, null, t[3]];
        var e = t[0] / 360, n = t[1], i = t[2], r = t[3], s = i <= .5 ? i * (1 + n) : i + n - i * n, a = 2 * i - s;
        return [Math.round(255 * o(a, s, e + 1 / 3)), Math.round(255 * o(a, s, e)), Math.round(255 * o(a, s, e - 1 / 3)), r]
    }, f(l, function (i, o) {
        var r = o.props, a = o.cache, l = o.to, c = o.from;
        u.fn[i] = function (i) {
            if (l && !this[a] && (this[a] = l(this._rgba)), i === e)return this[a].slice();
            var o, s = t.type(i), p = "array" === s || "object" === s ? i : arguments, h = this[a].slice();
            ...
            u.fn[e] || (u.fn[e] = function (o) {
                var r, a = t.type(o), u = "alpha" === e ? this._hsla ? "hsla" : "rgba" : i, l = this[u](), c = l[n.idx];
    ...
    o.initAngleGetterSetter = function () {
        ...
        } : this.lastMouseEvent = {pageX: t.pageX || t.clientX, pageY: t.pageY || t.clientY})
    }, o.update = function () {
        ...
        var n = t * (Math.PI / 180), i = e * (Math.PI / 180), o = Math.atan2(Math.sin(n - i), Math.cos(n - i)), r = o * (180 / Math.PI);
        ...
        var e = t.pageX - this.cx, i = t.pageY - this.cy, o = Math.atan2(e, i), r = o * (180 / Math.PI * -1) + 180;
        if (void 0 === this.lastMouseAngle && (this.lastElementAngle = this.virtualAngle, this.lastMouseAngle = r), this.stepTransitionTime !== n.stepTransitionTime)this.speed = this.mouseDiff = this.differenceBetweenAngles(r, this.lastMouseAngle), this.virtualAngle = this.lastElementAngle + this.mouseDiff, this.lastElementAngle = this.virtualAngle, this.lastMouseAngle = r; else {
        ...
        var t, e = document.createElement("p"), n = {
        ...
        if (e.x += t.offsetLeft - (i ? i.scrollLeft : 0), e.y += t.offsetTop - (i ? i.scrollTop : 0), i) {
            if (1 == i.nodeType) {
                ...
                if ("static" != o.position) {
                    if (e.x += parseInt(o.borderLeftWidth), e.y += parseInt(o.borderTopWidth), "table" == i.localName.toLowerCase())e.x += parseInt(o.paddingLeft), e.y += parseInt(o.paddingTop); else if ("body" == i.localName.toLowerCase()) {
    ...
    i.prototype.init = function () {
        ...
        if (void 0 !== this.moveEvent) {
            var n = this.normalizeEvent(this.moveEvent), i = e.parseInt(n.pep.x / this.options.grid[0]) * this.options.grid[0], o = e.parseInt(n.pep.y / this.options.grid[1]) * this.options.grid[1];
            this.addToLIFO({time: n.timeStamp, x: i, y: o});
            var r, s;
            ...
            var a = Math.abs(this.startX - i), u = Math.abs(this.startY - o);
            ...
            this.log({type: "event", event: n.type}), this.log({
                type: "event-coords",
                x: this.ev.x,
                y: this.ev.y
        ...
        var i = (this.$el.position(), this.velocity()), o = (this.dt, i.x / this.scale * this.options.multiplier), r = i.y / this.scale * this.options.multiplier, s = this.handleConstraint(o, r, !0);
        this.cssAnimationsSupported() && this.$el.css(this.getCSSEaseHash());
        var a = i.x > 0 ? "+=" + o : "-=" + Math.abs(o), u = i.y > 0 ? "+=" + r : "-=" + Math.abs(r);
        ...
        this.log({type: "delta", x: t, y: e}), n ? this.$el.animate({
            top: e,
            left: t
        ...
        var n = t[0].getBoundingClientRect(), i = e[0].getBoundingClientRect();
        ...
        var t = !1, e = document.createElement("div"), n = "Webkit Moz O ms Khtml".split(" "), i = "";
        if (e.style.animationName && (t = !0), !1 === t)for (var o = 0; o < n.length; o++)if (void 0 !== e.style[n[o] + "AnimationName"]) {
